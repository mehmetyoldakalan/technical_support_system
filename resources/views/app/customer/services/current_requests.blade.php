        ...
        <div class="col-12">
            <div class="card mb-4">
                <div class="card-header pb-0">
                    <h6>Mevcut Hizmet Taleplerim</h6>
                </div>
                <div class="card-body px-0 pt-0 pb-2">
                    <div class="table-responsive p-0">
                        <table class="table align-items-center mb-0">
                            ...
                            <tbody>
                            @foreach($requestList as $requests=>$request)
                            <tr>
                                <td>
                                ...
                                <td class="align-middle">
                                    <a href="{{route('app.customer.current_services_request_details',['id'=>$request->id])}}" class="text-secondary font-weight-bold text-xs" data-toggle="tooltip" data-original-title="Edit user">
